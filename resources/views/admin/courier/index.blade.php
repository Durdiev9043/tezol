                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                                                ...
                                                                @foreach($couriers as $courier)
                                                                    ...
                                                                    <tr>
                                                                        <th scope="row"><a href="#">{{$courier -> id }}</a></th>
                                                                        <td>
                                                                            <form action="{{route('courier.update',$courier->id)}}" method="POST" accept-charset="UTF-8"
                                                                                  enctype="multipart/form-data">
                                                                                @csrf
                                                                                @METHOD('PUT')
                                                                                <input style="border:none" type="text" name="name" value="{{$courier->name}}" >
                                                                            </form>
                                                                        </td>
                                                                        <td>
                                                                            <form action="{{route('courier.update',$courier->id)}}" method="POST" accept-charset="UTF-8"
                                                                                ...
                                                                                @csrf
                                                                                @METHOD('PUT')
                                                                                <input style="border:none" type="text" name="phone" value="{{$courier->phone}}" >
                                                                            </form>
                                                                        </td>
...
{{--                                        'verify_code_status',--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="phone" aria-describedby="emailHelp" placeholder="phone">
                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                        </div>
                                        <div class="form-group">
